...
A token is used to identify the user and to authenticate the request to the server.

- [ ] What steps can you take in your web apps to keep your data secure?

Use authentication and private routes to ensure only authenticated users can access data.

- [ ] Describe how web servers work.

Web servers are computers and programs that serve the code of an application using http protocols.
